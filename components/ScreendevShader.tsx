...
export function ScreendevShader({ theme = "dark", background, time, onError, className, style }: ScreendevShaderProps) {
...
function animate(options: ShaderOptions, draw: (time: number, theme: number, pixelRatio: number) => void, canvas: HTMLCanvasElement, release: () => void, maxDimension: number): ShaderHandle {

    ...
    <div className="filter-shell space-y-3 rounded-xl p-3">
      <div className="grid gap-2 lg:grid-cols-[minmax(320px,1fr)_180px_210px_auto]">
        <label className="relative block">
          ...
          <Input ref={searchRef} value={query} onChange={(event) => onQueryChange(event.target.value)} placeholder="Search libraries, tags, or keywords..." aria-label="Search libraries" className="coss-input h-10 w-full pr-16 pl-10" />
